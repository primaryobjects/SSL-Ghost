...
namespace SSLGhost.Providers
{
    public class MyMembershipProvider : MembershipProvider
    {
        ...
        {
            if (username == "casper" && password == "fear")
            {
                // Simulate a user id.
                int userId = 1;

                // Add the user details to cache, for quick retrieval later.
                HttpRuntime.Cache.Add(username, new MyMembershipUser(userId, username), null, Cache.NoAbsoluteExpiration, FormsAuthentication.Timeout, CacheItemPriority.Default, null);
        ...
        public override MembershipUser GetUser(string username, bool userIsOnline)
        {
            ...
            MyMembershipUser membershipUser = (MyMembershipUser)HttpRuntime.Cache.Get(username);
